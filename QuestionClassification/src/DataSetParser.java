...
public class DataSetParser {
    ...
    public static void main (String[] args) throws IOException {
        BufferedReader br = new BufferedReader(new FileReader("src\\TrainingData.txt"));
        ...
        Writer wr = new BufferedWriter(new OutputStreamWriter(new FileOutputStream("out.txt")));
