...
public class NERClassifier {
    private static final String _3classGrammarPath = "stanford-corenlp-full-2015-01-30\\stanford-corenlp-3.5.1-models\\edu\\stanford\\nlp\\models\\ner\\english.all.3class.distsim.crf.ser.gz";
    private static final String _7classGrammarPath = "stanford-corenlp-full-2015-01-30\\stanford-corenlp-3.5.1-models\\edu\\stanford\\nlp\\models\\ner\\english.muc.7class.distsim.crf.ser.gz";
