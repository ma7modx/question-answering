...
public class QuestionAnalysis {
    ...
    public Vector<String> getDependencyTree ()
    {
        /*
        for (Dependency i : this.parseTree.dependencies())
        {
           System.out.println( i.toString() ); ;
            System.out.println( i.dependent().value());
            System.out.println( i.name() );
            System.out.println( i.governor().value());
        }
        */
        return null ;
    }
